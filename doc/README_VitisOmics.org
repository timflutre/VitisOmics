...
TODO: compare scaffold sequences of 12x one by one between URGI and NCBI to understand the discrepancy
...
TODO: concatenate unplaced scaffolds into a single chrUn ?
...
echo "../../src/reformat_chr_NCBI-build-1-1.bash" \
