...
Note that, as of January 2016, even though two articles are published which used this genotyping array, the data are not (yet?) part of [[http://www.ncbi.nlm.nih.gov/projects/SNP/][dbSNP]], unfortunately.
